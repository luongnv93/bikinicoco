        ...
        <div class="container header-middle" >
            <div class="row" >
                <div class="col-md-2 logo">
                    <a href="/#/"><img ng-src="/uploads/images/theme_options/@{{ option.logo }}" class="img-responsive" alt=""></a>
                </div>
            ...
            <div class="container">
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a ng-click="reload()" href="{{url('/#/trang-tin/thiet-ke')}}" >Thiết kế</a></li>
                        <li><a ng-click="reload()" href="{{url('/#/trang-tin/blog-nha-dep')}}">Blog nhà đẹp</a></li>
                        <li><a  ng-click="reload()" href="{{url('/#/trang-tin/tin-tuc')}}" >Tin tức</a></li>
