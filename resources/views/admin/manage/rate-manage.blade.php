...
@section('breadcrumb')
   ...
   <li>
   <a href="{{url('admin/manage/rates')}}">Product Rate Manage</a>
   <i class="fa fa-angle-right"></i>
   </li>

@stop
@section('content')
	<div class="row" ng-controller="RateController">
		<div class="col-md-12">
		    <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-star font-red-sunglo"></i>
                        <span class="caption-subject font-red-sunglo bold uppercase">Product Rate</span>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="row">
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    <tr dir-paginate="rate in rates | itemsPerPage:pageSize |filter:search" current-page="currentPage">
                                        <td>@{{ rate.id }}</td>
                                        <td>@{{ rate.rate }} sao</td>
                                        <td>@{{ rate.name }}</td>
                                        <td>@{{ rate.email }}</td>
                                        <td>@{{ rate.content }}</td>
                                        <td><button ng-really-message="Are you sur?" ng-really-click="DeleteRate($index,rate.id)" class="btn btn-danger btn-sm"><i class="fa fa-times"></i></button></td>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="clearfix">
