...
@section('breadcrumb')
   ...
   <li>
   <a href="{{url('admin/post/trash')}}">Trash</a>
   <i class="fa fa-angle-right"></i>
   </li>
@stop
@section('content')
	<div class="row">
					<div class="col-md-12" ng-controller='PostTrash'>

							<div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-bars font-red-sunglo"></i>
                                        <span class="caption-subject font-red-sunglo bold uppercase">All Trash</span>
                                                ...
                                                <table class="table table-striped table-hover table-bordered">
                                                            ...
                                                            <tbody  dir-paginate="post in posts | itemsPerPage:pageSize | filter:search" current-page="currentPage" >
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="10%">
                                                                        <button class="btn btn-primary btn-sm" ng-click="restorePost($index,post.id)"><i class="fa fa-reply"></i></button>
                                                                        <button class="btn btn-danger btn-sm" ng-really-message="Are you sure?" ng-really-click="removePost($index,post.id)"><i class="fa fa-times"></i></button>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        <div class="clear-fix"></div>
                                                        <div ng-if="posts.length == 0" class="col-md-12 text-center">Chưa có bài viết trong thùng rác</div>
