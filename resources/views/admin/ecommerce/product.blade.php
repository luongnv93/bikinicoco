        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="portlet light">
                    ...
                    <div class="portlet-body">
                        <div class="form-group">
                            <input id="input-4" data-show-upload="false" data-show-filename="false" name="galery[]"
            ...
            <div class="col-md-4">
                    ...
                    <div class="portlet-body">
                        @foreach($attributes_cate as $attribute_cate)
                            ...
                            @foreach($attribute_cate->attributes as $attribute)
                                <label class="checkbox-inline input-sm"><input name="attributes[]" type="checkbox"
                                                                               value="{{$attribute->id}}">
                ...
                <div class="portlet light">
                    ...
                    <div class="portlet-body">
                        <input id="input-image" name="feature_image" type="file" class="file" data-show-upload="false"
                               data-show-filename="false" data-preview-file-type="text" required>
                    </div>
                </div>
                <!-- END ALERTS PORTLET-->
