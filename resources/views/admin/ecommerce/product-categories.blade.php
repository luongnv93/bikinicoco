                                ...
                                <div class="portlet-body">
                                    <div class="tabbable-custom nav-justified">
                                        <form role="form" id="form" class="form-horizontal" method="POST"
                                              ...
                                              action="{{url('admin/ecommerce/categories')}}">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Father:<span
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input id="input-image" name="image" type="file" class="file"
                                                           data-show-upload="false" data-preview-file-type="text">
                                                </div>
                                            </div>
                                            <hr/>
                                            {{--<div class="form-group">--}}
                                                {{--<label class="col-md-2 control-label">Meta title: <span--}}
                                                            {{--class="required">--}}
																	{{--* </span>--}}
                                                {{--</label>--}}
                                            ...
                                            {{--</div>--}}
                                            {{--<div class="form-group">--}}
                                                {{--<label class="col-md-2 control-label">Meta description:<span--}}
                                                            {{--class="required">--}}
																	{{--* </span>--}}
                                                {{--</label>--}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <button type="submit" class="btn green-haze btn-circle"><i
                                    ...
                                    <table class="table table-striped table-hover table-bordered">
                                        ...
                                        @foreach($categories as $category)
                                            <tr>
                                                <td>{{$category->id}}</td>
                                                <td width="10%"><img src="/uploads/images/ecommerce/{{$category->img}}"
                                                                     class="img-responsive" alt="td"/>
                                                <td>{{$category->name}}</td>
                                                <td>{{$category->description}}</td>
                                                <td>{{$category->slug}}</td>
                                                <td width="5%"><a href="" data-toggle="modal"
                                                ...
                                                <div id="myModal{{$category->id}}" class="modal fade" role="dialog">
                                                    <div class="modal-dialog">
                                                        <!-- Modal content-->
                                                        <form action="{{url('admin/ecommerce/categories/edit')}}"
                                                              role="form" id="form" class="form-horizontal"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                        ...
                                                                        <select class="form-control input-sm"
                                                                            ...
                                                                            @foreach($categories_father as $category_father)
                                                                                @if($category->father_id  == $category_father->id)
                                                                                    <option selected
                                                                                            value="{{$category_father->id}}">{{$category_father->name}}</option>
                                                                                @else
                                                                    ...
                                                                    <button type="button" class="btn btn-success btn-sm"
                                                                            ...
                                                                            data-target="#image{{$category->id}}">Change
                                                                        Image ?
                                                                    </button>
                                                ...
                                                <div id="Delete{{$category->id}}" class="modal fade" role="dialog">
                                                    <div class="modal-dialog">
                                                        <!-- Modal content-->
                                                        <form action="{{url('admin/ecommerce/categories/delete')}}"
                                                              method="POST">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <button type="button" class="close"
