                    ...
                    <div class="tabbable">
                        ...
                        <div class="tab-content no-space">
                            <div class="tab-pane active" id="tab_general"
                                 style="background-color: #ecf0f1; padding-top: 20px;">
                                <div class="col-md-12">
                                ...
                                <form action="{{url('admin/ecommerce/product/edit-product-text')}}" method="POST"
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control input-sm" name="sku"
                                                                   value="{{$product->sku}}" id="sku" value="#"
                                                                   required/>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="content" class="ckeditor" id="" cols="30"
                                                                      rows="10"
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <button data-toggle="modal" data-target="#editFeatureImage"
                                                        class="btn btn-danger btn-sm"><i class=" fa fa-pencil"></i>
                                                </button>
                                                <a href="/uploads/images/ecommerce/{{$product->feature_image}}"
                                                   target="_blank">
                                                    <button class="btn btn-sm btn-success"><i class="fa fa-eye"></i>
                                                    </button>
                                                </a>
                                                ...
                                                <div id="editFeatureImage" class="modal fade" role="dialog">
                                                    <div class="modal-dialog">
                                                        <!-- Modal content-->
                                                        <form action="{{url('admin/ecommerce/product/edit-product-feature-image')}}"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <img src="/uploads/images/ecommerce/{{$product->feature_image}}"
                                                                         class="img-responsive" alt=""/>
                                                                    <input id="input-image" name="feature_image"
                                                                           type="file" class="file"
                                                                           data-show-upload="false"
                                                                           data-show-filename="false"
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="submit"
                                                                            class="btn btn-sm btn-primary">Save change
                                                                    </button>
                                        ...
                                        <div class="row">
                                            @foreach($product->galeries as $galery)
                                                <div class="col-md-3">
                                                    <img src="/uploads/images/ecommerce/{{$galery->img}}"
                                                         class="img-responsive" alt=""/>
                                                    <a href="" data-toggle="modal"
                                                       data-target="#editGalery{{$galery->id}}">
                                                        <button class="btn btn-sm btn-primary"><i
                                                                    class="fa fa-pencil"></i></button>
                                                    </a>

                                                    <div id="editGalery{{$galery->id}}" class="modal fade"
                                                         role="dialog">
                                                        <div class="modal-dialog">
                                                            <!-- Modal content-->
                                                            <form action="{{url('/admin/ecommerce/product/edit-product-galery')}}"
                                                                  method="POST" enctype="multipart/form-data">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <button type="button" class="close"
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <input type="hidden" name="product_id"
                                                                               value="{{$product->id}}"/>
                                                                        <input id="input-4" name="galery" type="file"
                                                    ...
                                                    <a href="" data-toggle="modal"
                                                       data-target="#deleteGalery{{$galery->id}}">
                                                        <button class="btn btn-sm btn-danger"><i
                                                                    class="fa fa-times"></i></button>
                                                    </a>

                                                    <div id="deleteGalery{{$galery->id}}" class="modal fade"
                                                         role="dialog">
                                                        <div class="modal-dialog">
                                                            <!-- Modal content-->
                                                            <form action="{{url('/admin/ecommerce/product/delete-product-galery')}}"
                                                                  method="POST" enctype="multipart/form-data">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <button type="button" class="close"
                                                    ...
                                                    <a href="/uploads/images/ecommerce/{{$galery->img}}"
                                                       target="_blank">
                                                        <button class="btn btn-sm btn-success"><i class="fa fa-eye"></i>
                                                        </button>
                                                    </a>
                                        ...
                                        <hr/>
                                        <a href="" data-toggle="modal" data-target="#CreateGalery">
                                            <button type="button" class="btn green-haze btn-circle"><i
                                        ...
                                        <div id="CreateGalery" class="modal fade" role="dialog">
                                            <div class="modal-dialog">
                                                <!-- Modal content-->
                                                <form action="{{url('/admin/ecommerce/product/create-product-galery')}}"
                                                      method="POST" enctype="multipart/form-data">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close"
                                                                    data-dismiss="modal">&times;</button>
                                                            <h4 class="modal-title">Create new galery in this
                                                                product</h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <input id="input-4" name="galery[]" multiple="true"
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-sm btn-danger">Create
                                                            </button>
                                                            <button type="button" class="btn btn-default btn-sm"
                                                                    data-dismiss="modal">Close
                                                            </button>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                @foreach($product->attributes as $attribute)
                                                    <a href="/admin/ecommerce/product/delete-attribute/{{$product->id}}/{{$attribute->id}}">
                                                        <li>{{$attribute->name}} <span><i
                                                ...
                                                <form action="/admin/ecommerce/product/add-attribute" method="POST">
                                                    @foreach($attributes_cate as $attribute_cate)
                                                        ...
                                                        @foreach($attribute_cate->attributes as $attribute)
                                                            <label class="checkbox-inline input-sm"><input
