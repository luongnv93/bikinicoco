                ...
                <div class="col-md-8">
                    <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="3000">
                        <div class="carousel-inner" role="listbox">
                            <div class="item active" ng-if="slide.id == 1" ng-repeat="slide in slides">
                                <img ng-src="/uploads/images/theme_options/@{{slide.img}}" class="img-responsive">
                            </div>
                            <div class="item" ng-if="slide.id != 1" ng-repeat="slide in slides">
                                <img ng-src="/uploads/images/theme_options/@{{slide.img}}" class="img-responsive">
                            </div>
                        </div>
                        ...
                        <a class="right carousel-control" data-toggle="#myCarousel" role="button" data-slide="next">
                            <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
                            <span class="sr-only">Next</span>
                        </a>
                    </div>
                </div>
                <div class="col-md-4 visible-lg" id="social" ng-include src="'/angular-js/html/social.html'" ></div>
            </div>
            <div class="row">
                <div class="col-md-8">
                    <div class="blog container-fluid">
                        ...
                        @foreach($posts as $post)
                            <div class="col-md-6 col-xs-6 blog-item">
                                <a href="/blog-nha-dep/{{$post->slug}}"><h3 class="text-uppercase">{{$post->name}}</h3></a>
                                <div class="date"><span class="label label-success">{{date("d-m-Y", strtotime($post->created_at))}}</span></div>
                                <hr/>
                                <a href="/blog-nha-dep/{{$post->slug}}"><img ng-src="/uploads/images/post/{{$post->img}}" class="img-responsive" alt=""></a>
                            </div>
                        </div>
                        @endforeach
                </div>
