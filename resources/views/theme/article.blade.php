                    ...
                    <div class="blog container-fluid">
                        ...
                        @foreach($posts as $post)
                            <div class="col-md-6 col-xs-6 blog-item">
                                <a href="/tin-tuc/{{$post->slug}}"><h3 class="text-uppercase">{{$post->name}}</h3></a>
                                <div class="date"><span class="label label-success">{{date("d-m-Y", strtotime($post->created_at))}}</span></div>
                                <hr/>
                                <a href="/tin-tuc/{{$post->slug}}"><img ng-src="/uploads/images/post/{{$post->img}}" class="img-responsive" alt=""></a>
                            </div>
                        </div>
                        @endforeach
                </div>
